...
class TestVepFunctionalAnnotator:
    ...
    def test__process_item_missense(
            self,
            variant_annotator: VepFunctionalAnnotator,
            fpath_vep_response_dir: str,
    ):
        response_fpath = os.path.join(fpath_vep_response_dir, 'missense.json')
    ...
    def test__process_item_deletion(
            self,
            variant_annotator: VepFunctionalAnnotator,
            fpath_vep_response_dir: str,
    ):
        response_fpath = os.path.join(fpath_vep_response_dir, 'deletion.json')
        response = load_response_json(response_fpath)
