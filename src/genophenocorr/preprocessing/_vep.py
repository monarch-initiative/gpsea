...
from ._api import FunctionalAnnotator, ProteinMetadataService, VariantCoordinateFinder, T
...
class VepHgvsVariantCoordinateFinder(VariantCoordinateFinder[typing.Tuple[str, str]]):
    """
    `VepHgvsVariantCoordinateFinder` uses Ensembl's Variant Effect Predictor (VEP) REST API to build
