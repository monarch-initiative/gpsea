...
class CohortAnalysisConfiguration:
    """
    `CohortAnalysisConfiguration` is a value class for storing :class:`~gpsea.analysis.CohortAnalysis`
...
def configure_cohort_analysis(
    ...
    """
    Configure :class:`~gpsea.analysis.CohortAnalysis` for given `cohort`.

    :param cohort: a :class:`~gpsea.model.Cohort` to analyze
